...
const prompt = new PromptTemplate({
  ...
  so imagine you are in the universe of harry potter
   a scene inside the quidditch pitch where the following characters are present : {characters},

   your task is to:
   1. give me an output in json format.
   2. where json includes, summary of what happens inside quidditch pitch with my characters.
